      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/uploads/{{ Auth::user()->user_img }}" width="160" height="160" class="user-image img-profile" alt="{{ Auth::user()->name }}">
              <span class="hidden-xs">{{ Auth::user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- user image -->
              <li class="user-header">
                <img src="/uploads/{{ Auth::user()->user_img }}" width="160" height="160" class="img-circle img-profile" alt="{{ Auth::user()->name }}">
